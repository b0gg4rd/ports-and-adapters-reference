# Ports And Adapters Reference - Undertow MongoDB

## Overview

Infrastructure module implementing the **inbound** (Undertow REST) and **outbound** (MongoDB) adapters for the `ports-and-adapters-reference-core`. It exposes an API for the `Payment` domain.
...
flowchart LR
  subgraph Infrastructure ["Infrastructure (Adapters)"]
    ...
    A_OUT[Outbound Adapters\nMongoDbPaymentPersistenceAdapter]
    FW[["Undertow"]]
  end
...
└── infrastructure/
    ...
    │       ├── persistence/mongodb/
    │       │   ├── MongoDbPaymentPersistenceAdapter.java
    │       │   └── model/
    │       │       ├── PaymentDocument.java
    │       │       └── mapper/
    │       │           └── MongoDbPaymentPersistenceMapper.java
